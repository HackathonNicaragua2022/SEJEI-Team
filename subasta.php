...
<body style="background-color:#5B1F00">
    ...
    <?php
      if (isset($_POST["ofertar"])) {
        ...
        $fecha_hora_actual = date("Y-m-d H:i:s");
          ...
          if($oferta == $max){
            ...
            if($res_1 == false){
              ...
              if($res_2 == false){
                echo "<script>alert('No se pudo agregar ganado al carrito');</script>";
              }else{
        ...
        //Si el usuario quiere comprar el ganado pagando el monto maximo de la subasta
        $oferta = $_POST["max"];
        $id_user_1 = $_POST["id_user"];
        $id_sub_1 = $_POST["id_sub"];
        $max = $_POST["max"];
...
=======
                            Ganado <small>Haz tu mejor oferta</small>
>>>>>>> 88644aa51f56bc7d57bedbc32abb213a9a0d8337
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                        ...
                        while($row = $res->fetch_assoc()){
                          ...
                          if($res2->num_rows > 0){
                            while($row2 = $res2->fetch_assoc()){
                              ...
                              $categoria = $categoria_ar["categoria"];
                              ...
                              if($res3->num_rows > 0){
                                while($row3 = $res3->fetch_assoc()){
                                  ...
                                  <div class="col-sm-6 col-md-6">
                                      <?php
                                        //Aqui se mostrara la imagen del ganado en grande
                                  ...
                                  <div class="col-sm-6 col-md-6">
                                    <div class="thumbnail">
                                      ...
                                      <div class="caption">
                                        ...
                                        <p><?php echo "<b>Oferta minima:</b> C$$min.00"; ?></p>
                                        <p><?php echo "<b>Oferta maxima:</b> C$$max.00"; ?></p>
                                        <h4>Oferta actual: <b class="text-danger"><?php echo "C$$oferta.00"; ?></b></h4>
...
=======
                                            <p><?php echo "<b>Oferta minima:</b> C$$min.00"; ?></p>
                                            <p><?php echo "<b>Oferta maxima:</b> C$$max.00"; ?></p>
                                            <h4>Oferta actual: <b class="text-danger"><?php echo "C$0.00"; ?></b></h4>
>>>>>>> 88644aa51f56bc7d57bedbc32abb213a9a0d8337
...
=======
                            ...
                            echo "<h4>Hubo un error al recuperar el ganado</h4>";
                          }
